  ...
  return (
    <html lang="en">
      ...
      <body
        ...
        justify-between  overflow-x-hidden overflow-y-scroll scrollbar scrollbar-track-textDark/20 scrollbar-thumb-textDark/60 gap-10 container mx-auto p-4 md:px-16 "
      >
        <Header />
        {children}
        <Footer />
